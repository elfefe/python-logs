...
```
cd existing_repo
git remote add origin https://gitlab.com/exem2/libraries/logs.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/exem2/libraries/logs/-/settings/integrations)
